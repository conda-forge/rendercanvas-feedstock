...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/rendercanvas-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/rendercanvas-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add rendercanvas
# for installing globally
pixi global install rendercanvas
```
...
It is possible to list all of the versions of `rendercanvas` available on your platform:
...
```
pixi search rendercanvas --channel conda-forge
```
